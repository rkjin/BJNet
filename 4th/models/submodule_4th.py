...
class SpatialTransformer(nn.Module):
    ...
    def forward(self, left_input, right_input, disparity_samples):
        ...
        warped_right_feature_map = (1 - ((right_y_coordinate_1 < 0) + (right_y_coordinate_1 > right_input.size()[3] - 1)).float()) * (warped_right_feature_map) + torch.zeros_like(warped_right_feature_map)  #([1, 12, 16, 64, 128])
